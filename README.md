## RuboVision Engine
### 项目简介
部署在树莓派5的 Rust + OpenCV项目。集成颜色识别，二维码识别，GPIO状态灯，UART串口通信，cross检测。

[未来开发方向请点击这里](future.md) 

[这里是目前的bugs](/assets/md/bugslisting.md)
### 功能概述
...
#### 偶版本
* 功能与设备不关联:采用动态派发解耦，在项目启动时，设备进行软注册，后续根据通信信息进行调用
